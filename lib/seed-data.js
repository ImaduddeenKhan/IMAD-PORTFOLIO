  ...
  building: [
    {
      ...
      name: "PreClaw",
      tagline: "AI tech-planning workspace for faster startup discovery.",
      status: "building",
      url: "",
      videoUrl: "https://youtu.be/-sQnW4iusEo",
      logo: null,
      description:
        "Recommends practical, cost-effective stacks for startup ideas. | Converts discovery from weeks of research into minutes of guided planning. | Helps founders compare tools, architecture, and build direction before spending on development.",
    },
    {
      id: "career-compass",
      name: "Career Compass",
