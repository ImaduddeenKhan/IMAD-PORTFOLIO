  ...
  building: [
    {
      ...
      logo: null,
      description:
        "Describe your app idea in plain English — PreClaw designs a cost-efficient architecture. | Generates structured, multi-part prompts to feed directly into Cursor or Lovable. | Prevents over-engineering and equips you with structural precision before coding.",
    },
    {
      id: "career-compass",
      name: "Career Compass",
      ...
      logo: null,
      description:
        "AI guidance, career mapping, college paths, and local job discovery for Indian youth. | Designed for 10th/12th pass students, unskilled youth, and learners without career support. | A free, simple, and action-oriented experience for young people to make career decisions.",
    },
  ],
  certifications: [],
  achievements: [
