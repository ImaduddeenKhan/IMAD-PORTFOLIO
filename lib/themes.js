...
export const FONTS = {
  ...
  outfit: { name: "Outfit", stack: "Outfit, system-ui, sans-serif", url: "Outfit:wght@400;500;600;700" },
  raleway: { name: "Raleway", stack: "Raleway, system-ui, sans-serif", url: "Raleway:wght@400;500;600;700" },
  "plus-jakarta": { name: "Plus Jakarta Sans", stack: "'Plus Jakarta Sans', system-ui, sans-serif", url: "Plus+Jakarta+Sans:wght@400;500;600;700" },
  manrope: { name: "Manrope", stack: "Manrope, system-ui, sans-serif", url: "Manrope:wght@400;500;600;700" },
  "work-sans": { name: "Work Sans", stack: "'Work Sans', system-ui, sans-serif", url: "Work+Sans:wght@400;500;600;700" },
  montserrat: { name: "Montserrat", stack: "Montserrat, system-ui, sans-serif", url: "Montserrat:wght@400;500;600;700" },
  roboto: { name: "Roboto", stack: "Roboto, system-ui, sans-serif", url: "Roboto:wght@400;500;700" },
};
